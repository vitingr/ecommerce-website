...
const page = () => {
  return (
    <div className='w-full flex flex-col justify-center items-center p-[2%]'>
      ...
      <section className='mt-14 flex gap-8 flex-wrap justify-center'>
        <DestaqueCellphone link={"/buy/cellphone-650c8d5a26cb4afd9d500182"} title={"Samsung Galaxy S23 Ultra"} description={"Criado com qualidade em mente"} photo={"http://res.cloudinary.com/djwne0azq/image/upload/v1695321433/ap5gurs4rgcpnxi6ft9j.png"} />
        <DestaqueCellphone link={"/buy/cellphone-650c8d9826cb4afd9d500183"} title={"Samsung Galaxy S22 Plus"} description={"Criado com qualidade em mente"} photo={"http://res.cloudinary.com/djwne0azq/image/upload/v1695321497/ehvtn7hdxja69hs8kugl.avif"} />
        <DestaqueCellphone link={"/buy/cellphone-650c919c26cb4afd9d50018c"} title={"Apple Iphone 14 Plus"} description={"Criado com qualidade em mente"} photo={"http://res.cloudinary.com/djwne0azq/image/upload/v1695322524/cwkspzonlat6pgto40nu.png"} />
        <DestaqueCellphone link={"/buy/cellphone-650dd043921e13b33ed4f0a6"} title={"Samsung Galaxy S23 Plus"} description={"Criado com qualidade em mente"} photo={"https://planoscelular.claro.com.br/medias/18175-1-um-300Wx300H-productCard?context=bWFzdGVyfGltYWdlc3w0MzMwMHxpbWFnZS9wbmd8aGQwL2hhMy85MTkyMDUzOTY0ODMwLzE4MTc1XzFfdW1fMzAwV3gzMDBIX3Byb2R1Y3RDYXJkfDAyOWEzZjEzNGZiYWMxNGZmYTBkOTk3ZWM0ZWNlNWJkZWI4MDVlY2MxODgyODNiMTlhMjFhYWM2ZDZiN2Y3NTQ"} />
      </section>
      ...
      <section className='mt-32 w-full max-w-[1000px] flex flex-col justify-center items-center gap-36'>
        <div className='flex justify-between gap-24 medium:flex-wrap'>
